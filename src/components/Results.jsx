    ...
    return (
        ...
        <i onClick={props.hideResults} className="fa fa-window-close" id="results-close"></i>
          ...
          <h4>Category breakdown</h4>
            <p>Section 1: {props.score.correctAnswersSection1} / {props.score.questionsSection1}</p> <span>{isNaN(Percentages.section1)? 0 : Percentages.section1}%</span>
            <p>Section 2: {props.score.correctAnswersSection2} / {props.score.questionsSection2}</p> <span>{isNaN(Percentages.section2)? 0 : Percentages.section2}%</span>
            <p>Section 3: {props.score.correctAnswersSection3} / {props.score.questionsSection3}</p> <span>{isNaN(Percentages.section3)? 0 : Percentages.section3}%</span>
          </div>
